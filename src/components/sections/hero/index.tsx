    ...
    <div className="relative h-dvh w-full overflow-hidden bg-black">
      ...
      >
        <div className="flex w-full items-center gap-3">
          <p className="scale-y-120 text-3xl xl:text-5xl">2015</p>
          <div className="h-1 w-full bg-white" />
        </div>
        <p
          className={`${anton.className} scale-y-120 text-[5rem] leading-26 tracking-wide text-white uppercase xl:text-[7rem] xl:leading-40 2xl:text-[9rem] 2xl:leading-50 [@media(min-width:1920px)]:text-[11.5rem] [@media(min-width:1920px)]:leading-60`}
        >
          Shivamm
        </p>
        <div className="flex w-full items-center gap-3">
      ...
      >
        <div className="flex w-full items-center gap-3">
          <div className="h-1 w-full bg-white" />
          <p className="scale-y-120 text-3xl xl:text-5xl">Now</p>
        </div>
        <p
          className={`${anton.className} scale-y-120 text-[5rem] leading-26 tracking-wide text-white uppercase xl:text-[7rem] xl:leading-40 2xl:text-[9rem] 2xl:leading-50 [@media(min-width:1920px)]:text-[11.5rem] [@media(min-width:1920px)]:leading-60`}
        >
